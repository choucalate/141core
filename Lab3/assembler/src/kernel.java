...
class kernel{
    ...
    public static enum opcodes {
		ADDU, SUBU, SLLV, SRAV, SRLV, AND, OR, NOR, SLT, SLTU, MOV, LW, LBU, SW, SB, JALR, LROT, RROT, XOR,
	...
	public static void initialization() throws IOException {
		...
		opcodeTable.put("LROT" , "11111");
		// `define kRROT  16'b11110_?????_??????
		opcodeTable.put("RROT" , "11110");
		// `define kXOR   16'b11101_?????_??????
		opcodeTable.put("XOR"  , "11101");
	}
